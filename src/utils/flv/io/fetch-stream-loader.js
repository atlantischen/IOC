...
class FetchStreamLoader extends BaseLoader {
    ...
    destroy() {
        console.log(this.isWorking(),'this.isWorking()');
        if (this.isWorking()) {
            this.abort();
        }
        super.destroy();
    ...
    open(dataSource, range) {
        ...
        if (self.AbortController) {
            ...
            console.log(self.AbortController,this._abortController,'我执行了！！');
        ...
        self.fetch(seekConfig.url, params).then((res) => {
            ...
            if (this._abortController && this._abortController.signal.aborted) {
                console.log(this._abortController.signal.aborted,'this._abortController.signal.aborted');
                return;
            }
    ...
    abort() {
        ...
        console.log(this._abortController,'truesssssssss');
        if (this._abortController) {
            console.log('wochjifaleeeeeee');

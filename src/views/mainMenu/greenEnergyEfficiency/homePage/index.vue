      ...
      <div class="energy">
        ...
        <div class="energy_total">
          ...
          <div class="percentage">
            ...
            <span>
              <NumCounter :value="$randomNumer(1, 5, 2)"></NumCounter>%</span
            >
          </div>
        </div>
      </div>
    ...
    .energy_chart {
      ...
      ul {
        li {
          ...
          margin-bottom: 0.25rem /* 20/80 */ /* 10/80 */;
          .date {
            width: 0.35rem /* 28/80 */;
            height: 0.35rem;

            ...
            <ul class="outer">
                <li >
                    ...
                    <div class="content">
                        ...
                        <div class="describe">2021.06.01-2021.08.31期间，所有菜品8折优惠。</div>
                    </div>
                </li>
                <li >
                    ...
                    <div class="content">
                        ...
                        <div class="describe">2021年星巴克春季买一送一活动，活动时间：2021.5.12-6.15每天！下午！3:00!</div>
                    </div>
                </li>
                <li >
                    ...
                    <div class="content">
                        ...
                        <div class="describe">回馈新老用户，凡是在本店消费满99元可赠送20元代金券，2021.04.31前有效！</div>
                    </div>
                </li>
            </ul>
         </div>
       ...
       <IOCRight> 
            <div class="store_list">
                 ...
                 <div class="type">
                     <span>类型：</span>
                     <ul>
                         <li class="item" v-for="(item,index) in listType" :key="index">{{item}}</li>
                     </ul>
                 </div>
                 <div class="building">
                      <span>栋座：</span>
                     <ul>
                        <li class="item" v-for="(item,index) in listBuilding" :key="index">{{item}}</li>
                     </ul>
                 </div>
  ...
  methods:{
              ...
              meetEchartInit() {
                    ...
                    var option = {
                        ...
                        color:['#457EF3', '#CED392', '#08E2FF', '#CD9A57', '#46BDEF', '#95C7FF'],
                       legend: {
                          orient: 'horizontal',
                          top: 28,
                          color:'#fff',
...
.container{
  ...
  .store_discount{
       ...
       .outer{
           ...
           margin-top: .25rem /* 20/80 */;
            ...
            .content{
                margin-left: .175rem /* 15/80 */;
                .head{
                    font-size: .175rem /* 14/80 */ /* 15/80 */;
                    opacity: 0.7;
  ...
  .store_list{
      span{
            ...
            font-weight: bold;
            color: #FFFFFF;
            line-height: .25rem /* 20/80 */;
            margin-left: .375rem /* 30/80 *//* 40/80 */ /* 30/80 */;
            white-space: nowrap;
          }
        ul{
            display: flex;
        ...
        li{
            ...
            color: #fff;
            margin: 0 .25rem /* 20/80 */ /* 18/80 */ /* 20/80 *//* 24/80 */ .125rem /* 10/80 */ 0;
  ...
  .store_wait{
      ul{
          ...
          li{
             margin-right: .0625rem /* 5/80 */ /* 6/80 */ /* 8/80 *//* 10/80 */;
             margin-bottom: .0625rem /* 10/80 */; 
             img{
                 width: 1.1875rem /* 95/80 */ /* 100/80 */;
                 height: .725rem /* 58/80 */ /* 60/80 */;
             }
          }
      }
  }

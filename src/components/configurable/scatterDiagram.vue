...
export default {
  ...
  methods: {
    scatterDiagramFun(val) {
      ...
      var data = [
        [
          [120, 1200, 123, 92345345, "新能源", "2021"],
          [150, 2500, 354, 32334545, "零售商家", "2021"],
          [250, 4200, 23, 34342345, "信息技术", "2021"],
          [350, 3200, 423, 234343434, "新材料", "2021"],
          [350, 4100, 234, 32345535, "生物医药", "2021"],
          [550, 4900, 234, 32323423, "智能制造", "2021"],
          [650, 6500, 754, 12342542, "现代服务", "2021"],
          [680, 78.1, 32, 45452345, "节能环保", "2021"],
        ],
        [
          [150, 1500, 213, 304342345, "新能源", "2020"],
          [220, 2000, 234, 104342345, "零售商家", "2020"],
          [230, 4800, 652, 64342345, "信息技术", "2020"],
          [400, 3000, 23, 234587565, "新材料", "2020"],
          [400, 4500, 324, 23232345, "生物医药", "2020"],
          [450, 4200, 23, 42345345, "智能制造", "2020"],
          [490, 5000, 23, 72345345, "现代服务", "2020"],
          [550, 6800, 345, 35345646, "节能环保", "2020"],
        ],
      ];
      var option = {
        title: {

  ...
  <div id="IocRightPart" class="IocRightPart">
    <div class="ioc_video">
      <div class="qx_title">
        视频监控<a
          href="javascript:;;"
          @click="addMore('UI_EVENT_IOC_RightVideoSurveillance_More')"
    ...
    <div class="ioc_meeting">
      <div class="qx_title">
        会议室<a
          href="javascript:;;"
          @click="addMore('UI_EVENT_IOC_RightMeetingRoom_More')"
          >more <i class="iconfont icon-youjiantou"></i
        ></a>
      </div>
    ...
    <div class="ioc_WorkOrder">
      <div class="qx_title">
        工单管理<a
          href="javascript:;;"
          @click="addMore('UI_EVENT_IOC_RightWorkorderManagement_More')"
          >more <i class="iconfont icon-youjiantou"></i
        ></a>
      </div>
    ...
    <div class="ioc_park">
      <div class="qx_title">
        停车场<a
          href="javascript:;;"
          @click="addMore('UI_EVENT_IOC_RightParkingLot_More')"
          >more <i class="iconfont icon-youjiantou"></i
        ></a>
      </div>
      <div class="workOrder_datas">
